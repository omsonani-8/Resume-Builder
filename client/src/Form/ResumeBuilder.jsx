        ...
        <div className="flex ml-2 mt-10 relative">
            ...
            <div className="sticky top-28 w-[500px] h-fit shadow-2xl rounded-lg mr-8 p-6">
                <div className="">
                    {activeSection === "basic-info" && (
                        <BasicInfo basicInfo={basicInfo} activeSection={activeSection}
                                   setActiveSection={setActiveSection} setBasicInfo={setBasicInfo}/>
                    )}
            ...
            <div>
                <div className="pt-5 p-10 flex justify-center items-center" id="myPage">
                    <div className="font-sans text-gray-800  flex-col items-center ">
                        <div className=" flex-col items-center">
                            <div
                                className=" w-[850px] p-10 mx-auto bg-gray-100 border-t-8  border-b-2 border-gray-200">
                ...
                <div className="ml-3 w-full flex justify-around">
                    <ReactToPrint
                        trigger={() => <button
                            className="bg-blue-500 h-14 text-sm hover:bg-blue-700 text-white font-bold px-2 py-1 rounded mt-8 sticky">Print
                            Resume</button>}
