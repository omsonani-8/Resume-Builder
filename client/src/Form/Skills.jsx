                    ...
                    <li key={index} className="mb-2 flex justify-between items-center">
                        ...
                        <div>
                            <button onClick={() => handleEdit(index)}
                                    className="text-blue-500 hover:text-blue-700 transition-colors duration-200 px-2 py-1 rounded-md">Edit
                            </button>
                            <button onClick={() => handleRemove(index)}
                                    className="text-red-500 hover:text-red-700 ml-2 transition-colors duration-200 px-2 py-1 rounded-md">Remove
                            </button>
                        </div>
                    </li>
                ))}
